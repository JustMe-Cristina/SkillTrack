...
function getProfileLevel({
  skillsLength,
  jobsLength,
  completedRoadmapsLength,
  activeRoadmapsLength
}) {
  if (
    skillsLength >= 12 &&
    jobsLength >= 5 &&
    (completedRoadmapsLength > 0 || activeRoadmapsLength > 0)
  ) {
    return "Market Ready";
  }
...
export default function ProfilulMeu() {
  ...
  async function handleDeleteAccount() {
    const confirmed = window.confirm(
      "Ești sigură că vrei să ștergi definitiv contul? Această acțiune nu poate fi anulată."
    );
    ...
    try {
      ...
      setMessage(err.message || "Nu s-a putut șterge contul.");
    } finally {
            ...
            <section style={styles.directionCard}>
              ...
              <div style={styles.directionGrid}>
                ...
                <div style={styles.directionBox}>
                  ...
                  <strong>
                    {market?.bestNextSkill?.name || stats.topSkillCategory}
                  </strong>
                  <p>
...
const styles = {
  ...
  dangerZone: {
    ...
    borderRadius: 20,
    padding: 20,
    boxShadow: "0 10px 30px rgba(127,29,29,0.06)"
  },
